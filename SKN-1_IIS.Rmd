...
tot_rep_plot_CF <- dabest_plot(totrep_CF_dab_p, FALSE, raw_marker_spread = 1, swarm_label = 'Total reproduction',custom_palette = 'npg', swarm_x_text = 12, swarm_y_text = 12, contrast_y_text = 12, contrast_x_text = 12, raw_marker_alpha = 0.3, tufte_size = 1 )
...
#Coxme model
cox_SKN_25_only <- coxme(Surv(Age, Event) ~ Treatment.ID*Temperature + (1|Plate.ID), data = SKN_only_25)
