...
all_25_df$contrast <- fct_recode(all_25_df$contrast,
  ...
  "SKN-1: daf-2 + cycle - ev" = "daf_25F - ev_25",
  "N2: daf-2 - ev" = "daf - ev")
...
all_25_df <- all_25_df %>%
  mutate(label = recode(label,
    ...
    "SKN-1: daf_25F - ev_25" = "SKN-1: daf-2 + cycle - ev",
...
#Create survival curves
SKN_15_NM_plot <-ggsurvplot(surv_SKN15_NM, ylab="Survival probability\n", data = SKN_15_NM, size= 0.8, font.ylab= 14, font.xlab= 14, legend = c(0.2, 0.2), legend.title = "", title = "15°C", censor = FALSE, xlab = "\nDay", xlim=c(0,40), break.time.by = 5, position= position_dodge(0.9), font.tickslab = c(12), palette = c('#4DBBD5FF','#E64B35FF', '#3C5488FF','#F39B7FFF','#00A087FF'), font.legend = c(12),font.title = c(12),legend.labs = c('N2 daf-2', 'N2 ev','SKN-1 daf-2','SKN-1 daf-2 + cycle','SKN-1 ev'))
...
all_15_df$contrast <- fct_recode(all_15_df$contrast,
  ...
  "SKN-1: daf-2 + cycle - ev" = "daf_15F - ev_15",
  "N2: daf-2 - ev" = "daf - ev")
...
all_15_df <- all_15_df %>%
  mutate(label = recode(label,
    ...
    "SKN-1: daf_15F - ev_15" = "SKN-1: daf-2 + cycle - ev",
    "N2: daf - ev"           = "N2: daf-2 - ev"
  ))
